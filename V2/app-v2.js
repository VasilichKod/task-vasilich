...
function renderSidebarLists() {
  ...
  document.querySelector('.sidebar-collapse-btn').textContent = state.ui.sidebarCollapsed ? '⇥' : '⇤';
  document.querySelector('.sidebar-collapse-btn').title = state.ui.sidebarCollapsed ? 'Развернуть меню' : 'Свернуть меню';
